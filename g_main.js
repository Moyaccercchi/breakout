...
g_main._updateClocks = function (frameTime) {
    ...
    if (this._frameTime_ms === null) {
        ...
        this._firstframeTime_ms = frameTime;
    }
    ...
    if ((g_runmode === 0) && (frameTime - this._firstframeTime_ms > 4000)) {
        set_runmode(1);
    }
};
...
g_main.init = function () {
    ...
    //
    // As we are not in the fiddle here... let's do it! =)
    window.focus(true);
